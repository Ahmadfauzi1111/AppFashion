...
const Content = ({ children }: ContentProps) => {
    ...
    return (
        ...
        <View style={styles.background}>
            <Image style={styles.image} source={require("./assets/patterns/1.png")} />
            <Image style={styles.image} source={require("./assets/patterns/2.png")} />
            <Image style={styles.image} source={require("./assets/patterns/3.png")} />
        </View>
        {children}
        <Svg
            width={width}
